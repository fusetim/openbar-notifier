...
pub trait AuthApi: Send + Sync {
    ...
    async fn connect_card<'connect_card_request>(
        &self,
        connect_card_request: Option<models::ConnectCardRequest>,
    ) -> Result<models::ConnectCard200Response, Error<ConnectCardError>>;

    /// POST /auth/password
    ///
    /// Connect account with password
    async fn connect_password<'connect_password_request>(
        &self,
        connect_password_request: Option<models::ConnectPasswordRequest>,
    ) -> Result<models::ConnectCard200Response, Error<ConnectPasswordError>>;
...
impl AuthApi for AuthApiClient {
    ...
    async fn connect_card<'connect_card_request>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ConnectCardError> =
    ...
    async fn connect_password<'connect_password_request>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ConnectPasswordError> =
                serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent {
                status: local_var_status,
                content: local_var_content,
